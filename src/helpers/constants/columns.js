...
export const SESSION_COLUMN_SCRIPT_TORRENT_DONE_FILENAME =
  'script-torrent-done-filename';
export const SESSION_COLUMN_SCRIPT_TORRENT_DONE_ENABLED =
...
export const SESSION_COLUMN_TRASH_ORIGINAL_TORRENT_FILES =
